function expDes = runTrials_pursuit(scr, const, cFrame,expDes, my_key, aud)
% ----------------------------------------------------------------------
...
% Task 1 Pursuit
task_1_2_nbf_on = 1;
task_1_2_nbf_off = task_1_2_nbf_on + const.pursuit.dur_frm - 1; 
...
[const, c, vbl_pur] = playGuidedViewingBullsEye(const, scr, t, c, 'pursuit');
    

%Flip count
%task_1_2_nbf = cFrame + 1;
