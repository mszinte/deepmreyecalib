...
for t = 1:const.nb_trials
    ...
    switch task
        case 1: trial_offset = const.fixtask_dur_frm;
        case 2: trial_offset = const.pursuit_dur_frm;
        case 3: trial_offset = const.freeview_dur_frm;
    end
    ...
    while nbf <= trial_offset
        ...
        if task == 2
            if nbf >= pursuit_onset_nbf && nbf <= pursuit_offset_nbf
                drawBullsEye(scr, const, fix_x(nbf), fix_y(nbf))
            end
        end
